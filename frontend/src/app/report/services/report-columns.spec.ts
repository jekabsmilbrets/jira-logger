...
describe('Report Service ReportColumns', () => {
  ...
  it('adds tag totals before the total time logged column', () => {
    TestBed.configureTestingModule({
      providers: [{ provide: ReportDateCalendar, useValue: {} }, ReportColumns],
    });

    const columns = TestBed.inject(ReportColumns).buildColumns(state, ReportMode.total, false);
  ...
  it('uses total columns when no date has been selected', () => {
    ...
    expect(TestBed.inject(ReportColumns).buildColumns({ ...state, tags: [] }, ReportMode.date, false)
  ...
  it('uses total columns when a date range is incomplete', () => {
    ...
    expect(TestBed.inject(ReportColumns).buildColumns({
      ...state,
  ...
  it('reads logged and synced columns from one Report Date Accounting result', () => {
    ...
    const columns = TestBed.inject(ReportColumns).buildColumns({
      ...state,
      tags: [],
      date,
