...
describe('Report Service ReportState', () => {
  let service: ReportState;
  ...
  beforeEach(() => {
    ...
    TestBed.configureTestingModule({
      providers: [
        ...
        { provide: Tags, useValue: { tags: tagsState.asReadonly() } },
        { provide: Timezone, useValue: { timezone: 'UTC' } },
      ],
    });

    service = TestBed.inject(ReportState);
  });
  ...
  it('does not persist before hydration finishes and restores tags after they load later', async () => {
    ...
    TestBed.configureTestingModule({
      providers: [
        ...
        { provide: Tags, useValue: { tags: delayedTagsState.asReadonly() } },
        { provide: Timezone, useValue: { timezone: 'UTC' } },
      ],
    });

    const localService = TestBed.inject(ReportState);
