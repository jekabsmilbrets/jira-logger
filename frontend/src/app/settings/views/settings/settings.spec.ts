...
class UserSettingsConfiguratorStub {
  public readonly disabled = input(false);
  public readonly settings = input<Setting[]>([]);
...
class TagManagementConfiguratorStub {
  public readonly disabled = input(false);
...
describe('Settings View Component Settings', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed
      .configureTestingModule({
        imports: [Settings],
        providers: [
          { provide: LoaderState, useValue: { isLoading: signal(false).asReadonly() } },
          { provide: SettingsStore, useValue: settingsServiceMock },
          { provide: Tags, useValue: tagsServiceMock },
          { provide: Report, useValue: reportService },
          { provide: MatSnackBar, useValue: matSnackBarMock },
          { provide: SettingsChange, useValue: settingsChangeServiceMock },
        ],
      })
      .overrideComponent(
        Settings,
        {
          set: {
            imports: [
              ReportConfiguratorStub,
              JiraApiConfiguratorStub,
              UserSettingsConfiguratorStub,
              TagManagementConfiguratorStub,
            ],
          },
        },
      )
  ...
  it('binds configurator inputs from signal state', async () => {
    const reportCfg = fixture.debugElement.query(By.directive(ReportConfiguratorStub)).componentInstance as ReportConfiguratorStub;
    const jiraCfg = fixture.debugElement.query(By.directive(JiraApiConfiguratorStub)).componentInstance as JiraApiConfiguratorStub;
    const taskListCfg = fixture.debugElement.query(By.directive(TagManagementConfiguratorStub)).componentInstance as TagManagementConfiguratorStub;
    const timezoneCfg = fixture.debugElement.query(By.directive(UserSettingsConfiguratorStub)).componentInstance as UserSettingsConfiguratorStub;
...
describe('Settings Views settings integration', () => {
    ...
    await TestBed.resetTestingModule()
      .configureTestingModule({
        ...
        providers: [
          ...
          { provide: SettingsChange, useValue: { saveSettings: vi.fn(), saveTag: vi.fn() } },
        ],
      })
      .compileComponents();
  ...
  it('wires real child outputs through template listeners', async () => {
    ...
    const reportCfg = fixture.debugElement.query(By.directive(ReportConfigurator)).componentInstance as any;
    const jiraCfg = fixture.debugElement.query(By.directive(JiraApiConfigurator)).componentInstance as any;
    const timezoneCfg = fixture.debugElement.query(By.directive(UserSettingsConfigurator)).componentInstance as any;
