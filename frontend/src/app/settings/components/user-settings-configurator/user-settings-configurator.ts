...
@Component({
  ...
  templateUrl: './user-settings-configurator.html',
  styleUrls: ['./user-settings-configurator.scss'],
  standalone: true,
...
export class UserSettingsConfigurator {
  ...
  private getSupportedTimezones(): string[] {
    if (typeof Intl.supportedValuesOf !== 'function') {
      return UserSettingsConfigurator.timezoneFallback;
    }
