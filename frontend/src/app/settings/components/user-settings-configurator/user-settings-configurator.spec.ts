...
import { UserSettingsConfigurator } from './user-settings-configurator';

describe('Settings Components user-settings-configurator', () => {
  let fixture: ComponentFixture<UserSettingsConfigurator>;
  let component: UserSettingsConfigurator;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [UserSettingsConfigurator],
    }).compileComponents();

    fixture = TestBed.createComponent(UserSettingsConfigurator);
