...
import { AreYouSure } from '@shared/services/are-you-sure';

import { TagManagementConfigurator } from './tag-management-configurator';

describe('Settings Components tag-management-configurator', () => {
  let fixture: ComponentFixture<TagManagementConfigurator>;
  let component: TagManagementConfigurator;
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        { provide: AreYouSure, useValue: areYouSureServiceMock },
      ],
    }).compileComponents();

    fixture = TestBed.createComponent(TagManagementConfigurator);
