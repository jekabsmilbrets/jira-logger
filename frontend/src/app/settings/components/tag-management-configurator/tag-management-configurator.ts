...
@Component({
  ...
  templateUrl: './tag-management-configurator.html',
  styleUrls: ['./tag-management-configurator.scss'],
  standalone: true,
...
export class TagManagementConfigurator {
  private readonly areYouSureService: AreYouSure = inject(AreYouSure);
