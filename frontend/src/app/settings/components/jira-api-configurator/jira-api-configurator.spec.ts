...
import { JiraApiConfigurator } from './jira-api-configurator';

describe('Settings Components jira-api-configurator', () => {
  let fixture: ComponentFixture<JiraApiConfigurator>;
  let component: JiraApiConfigurator;
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      imports: [JiraApiConfigurator],
    }).compileComponents();

    fixture = TestBed.createComponent(JiraApiConfigurator);
