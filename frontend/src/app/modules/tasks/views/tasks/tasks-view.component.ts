...
export class TasksViewComponent implements OnInit {
  ...
  protected onAction([task, action]: [Task, TaskUpdateActionEnum]): void {
  ...
  protected onUpdate(task: Task): void {
  ...
  protected onCreateTimeLog([task, timeLog]: [Task, TimeLog]): void {
  ...
  protected onUpdateTimeLog([task, timeLog]: [Task, TimeLog]): void {
  ...
  protected onRemoveTimeLog([task, timeLog]: [Task, TimeLog]): void {
