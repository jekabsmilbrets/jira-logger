...
export const adaptJiraWorkLog = (apiJiraWorkLog: ApiJiraWorkLog): JiraWorkLog => new JiraWorkLog(
  {
...
export const adaptJiraWorkLogs = (apiJiraWorkLogs: ApiJiraWorkLog[]): JiraWorkLog[] => apiJiraWorkLogs.map(
