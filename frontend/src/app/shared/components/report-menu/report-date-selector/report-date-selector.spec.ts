...
describe('Shared Components report-date-selector', () => {
  const createComponent = async (): Promise<{
    fixture: ReturnType<typeof TestBed.createComponent<ReportDateSelector>>;
    component: ReportDateSelector;
  }> => {
    await TestBed.configureTestingModule({
      imports: [ReportDateSelector],
    }).compileComponents();

    const fixture = TestBed.createComponent(ReportDateSelector);
