...
import { ReportModeSwitcher } from './report-mode-switcher';

describe('Shared Components report-mode-switcher', () => {
  it('renders select options and emits reportModeChange', async () => {
    await TestBed.configureTestingModule({
      imports: [ReportModeSwitcher],
    }).compileComponents();

    const fixture = TestBed.createComponent(ReportModeSwitcher);
