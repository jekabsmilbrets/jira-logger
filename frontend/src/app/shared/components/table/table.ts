...
export class Table implements AfterViewInit {
  ...
  private readonly readableTimePipe: ReadableTime = new ReadableTime();
  ...
  protected shouldDisplayColumn(
    ...
    return !column.hidden &&
      ...
      !Table.hiddenLoopColumns.includes(column.columnDef);
  }
  ...
  private async confirmRowAction(
    ...
    const confirmation$: ReturnType<AreYouSure['openDialog']> | undefined = areYouSureService.openDialog(action.confirmLabel?.(row) ?? '');
