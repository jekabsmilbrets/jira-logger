...
describe('Shared Services tasks', () => {
  let service: Tasks;
  ...
  it('create reports error through ErrorDialog when request fails', async () => {
  ...
  it('registers its loader and loads unfiltered tasks into both collections', async () => {
    ...
    expect(service.loaderStateService.addLoader).toHaveBeenCalledWith(service.isLoading, 'Tasks');
  });
