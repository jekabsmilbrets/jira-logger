...
export const adaptSetting: (apiSetting: ApiSetting) => Setting = (apiSetting: ApiSetting): Setting =>
  new Setting({
    ...
    createdAt: apiSetting.createdAt ?
      new Date(apiSetting.createdAt) :
      undefined,
    updatedAt: apiSetting.updatedAt ?
      new Date(apiSetting.updatedAt) :
      undefined,
  });

export const adaptSettings: (apiSettings: ApiSetting[]) => Setting[] = (apiSettings: ApiSetting[]): Setting[] =>
  apiSettings.map((apiSetting: ApiSetting) => adaptSetting(apiSetting));
