...
import { JiraApiTaskIntakeService } from './jira-api-task-intake.service';

describe('JiraApiTaskIntakeService', () => {
  ...
  let service: JiraApiTaskIntakeService;
  ...
  beforeEach(() => {
    ...
    service = TestBed.inject(JiraApiTaskIntakeService);
  });
