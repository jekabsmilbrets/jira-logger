...
import { TaskBackup } from './task-backup';

describe('TaskBackup export', () => {
  let service: TaskBackup;

  beforeEach(() => {
    TestBed.configureTestingModule({
      providers: [
        TaskBackup,
        { provide: Tags, useValue: { tags: signal([]).asReadonly() } },
        { provide: Tasks, useValue: { allTasks: signal([]).asReadonly() } },
        { provide: TimeLogs, useValue: {} },
        { provide: LoaderState, useValue: {} },
      ],
    });

    service = TestBed.inject(TaskBackup);
  });
