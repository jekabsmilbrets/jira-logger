...
@Component({
  ...
  templateUrl: './time-log-modal.html',
  styleUrls: ['./time-log-modal.scss'],
  standalone: true,
...
export class TimeLogModal {
  ...
  private readonly dialogRef: MatDialogRef<TimeLogModal, undefined | TimeLogModalResponse> = inject<MatDialogRef<TimeLogModal, TimeLogModalResponse | undefined>>(MatDialogRef);
  ...
  private validateEndTime(
    startTime: Date | null,
    endTime: Date | null,
  ): typeof TimeLogModal.invalidChronologyError | null {
    ...
    return TimeLogModal.invalidChronologyError;
  }
