...
import { TimeLogList } from '@tasks/services/time-log-list';
...
describe('Tasks Components task', () => {
  ...
  const setup = async (
    ...
    await TestBed.configureTestingModule({
      imports: [Task],
      providers: [
        { provide: AreYouSure, useValue: areYouSureService },
        { provide: Tags, useValue: tagsService },
        { provide: Tasks, useValue: tasksService },
        { provide: TimeLogList, useValue: timeLogListService },
