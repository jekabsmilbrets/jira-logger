...
import { JiraApiTaskIntake } from '@tasks/services/jira-api-task-intake';

@Component({
  selector: 'tasks-jira-task-import-dialog',
  templateUrl: './jira-task-import-dialog.html',
  styleUrls: ['./jira-task-import-dialog.scss'],
  standalone: true,
  ...
  providers: [JiraApiTaskIntake],
})
export class JiraTaskImportDialog {
  private readonly dialogRef: MatDialogRef<JiraTaskImportDialog, boolean> = inject(MatDialogRef);
  private readonly matDialog: MatDialog = inject(MatDialog);
  private readonly matSnackBar: MatSnackBar = inject(MatSnackBar);
  private readonly tagsService: Tags = inject(Tags);
  private readonly intakeService: JiraApiTaskIntake = inject(JiraApiTaskIntake);
