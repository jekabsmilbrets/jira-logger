...
import { JiraTaskImportDialog } from './jira-task-import-dialog';

describe('JiraTaskImportDialog', () => {
  ...
  beforeEach(async () => {
    ...
    TestBed.overrideComponent(JiraTaskImportDialog, {
      set: {
        providers: [{ provide: JiraApiTaskIntake, useValue: intakeService }],
      },
    });
  ...
  it('restores criteria through the intake module and disables an ineffective search', async () => {
    const fixture = TestBed.createComponent(JiraTaskImportDialog);
