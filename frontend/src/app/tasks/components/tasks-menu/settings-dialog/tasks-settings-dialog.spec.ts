...
import { TasksSettingsDialog } from './tasks-settings-dialog';

describe('Tasks Components tasks-settings-dialog', () => {
  const dialogRefMock = {
    close: vi.fn(),
  };
  ...
  it('closes dialog without payload on onClose', () => {
    const fixture = TestBed.createComponent(TasksSettingsDialog);
  ...
  it('ignores destroyed-injector export errors during construction', () => {
    ...
    expect(() => TestBed.createComponent(TasksSettingsDialog)).not.toThrow();
  });
  ...
  it('rethrows unexpected export errors during construction', () => {
    ...
    expect(() => TestBed.createComponent(TasksSettingsDialog)).toThrow('backup export failed');
  });
});
