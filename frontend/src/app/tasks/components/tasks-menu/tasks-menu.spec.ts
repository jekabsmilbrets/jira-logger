...
describe('Tasks Components tasks-menu', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        ...
        { provide: TaskBackup, useValue: taskBackupServiceMock },
  ...
  it('opens settings dialog when settings toggle button is clicked', async () => {
    ...
    expect(matDialogMock.open).toHaveBeenCalledWith(TasksSettingsDialog, {
      data: {
        currentTasks: [],
      },
    });
