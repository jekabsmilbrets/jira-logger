...
class ReportHeaderMenu {
}

describe('Layout Views layout', () => {
  ...
  const tasksMenu: HeaderMenuRouteData = {
    menuId: 'tasks',
    menuComponent: TasksHeaderMenu,
  };
  const reportMenu: HeaderMenuRouteData = {
    menuId: 'report',
    menuComponent: ReportHeaderMenu,
  };
  ...
  beforeEach(async () => {
    await TestBed.configureTestingModule({
      ...
      .overrideComponent(Layout, {
        ...
        add: {
          imports: [MockHeader, MockSidenav],
        },
      })
      .compileComponents();
  });
  ...
  it('passes signal values to the header inputs', () => {
    ...
    const headerDebugEl = fixture.debugElement.query(By.directive(MockHeader));
    const headerComponent = headerDebugEl.componentInstance as MockHeader;
...
describe('Layout Views layout integration', () => {
